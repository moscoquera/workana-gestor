...
@if (isset($crud->child_resource_included['date']) && $crud->child_resource_included['date']==false)

    <?php
        $crud->child_resource_included['date']=true;
    ?>
        ...
        <script>
            ...
            var dateFormat = function() {
                ...
                return function(e, f, g) {
                    var h = dateFormat;
                    if (3 != arguments.length || "[object String]" != Object.prototype.toString.call(e) || /\d/.test(e) || (f = e, e = void 0), e = e ? new Date(e) : new Date, isNaN(e)){
                        console.log(1 != arguments.length || "[object String]" != Object.prototype.toString.call(e) || /\d/.test(e) || (f = e, e = void 0), e = e ? new Date(e) : new Date, isNaN(e));
                    }
