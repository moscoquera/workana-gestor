        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-header {{ $crud->hasAccess('create')?'with-border':'' }}">
                    ...
                    <a href="{{ url('events') }}" class="btn btn-warning"><i class="fa fa-backward"></i>Volver</a>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function($) {
            ...
            var table = $("#crudTable").DataTable({
                    ...
                    "aaSorting": [],
                    @if(isset($crud->list_order))
                        "order" : {!! json_encode($crud->list_order) !!},
                    @endif
